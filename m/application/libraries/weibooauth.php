...
{ 
    ...
    function my_me()
    {
        ...
        return $this->request_with_pager( 'https://api.weibo.com/2/comments/mentions.json' , $page , $count ); 
    ...
    function me_new($page = 1 , $count = 20){
    	
    	return $this->oauth->get( 'http://api.weibo.com/2/comments/mentions.json');
    }
