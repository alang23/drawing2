                ...
                <p class="xinxi">您还有 <span style=" color:#fd4d00; text-decoration:underline;"><?=$lotterynum?>次</span> 抽奖机会</p>
                 ...
                 <div class="grzx_tb">
                      <label for="UserName">真实姓名：&nbsp;&nbsp;</label>
                       <input type="text" name="realname" id="realname" value="<?=$info['realname']?>" style="display:none">
                      <p><?=$info['realname']?></p>
                      <label for="Address">联系地址：&nbsp;&nbsp;</label>
                      <input type="text" name="address" id="address" value="<?=$info['address']?>" style="display:none">
                       <p><?=$info['address']?></p>
                      <label for="UserName">联系电话：&nbsp;&nbsp;</label>
                    
                    <input type="text" name="phone" id="phone" value="<?=$info['phone']?>" style="display:none">
                      <p><?=$info['phone']?></p>
                    
                      <!--<div class="btn"><a href="<?=base_url()?>m/index.php?c=user&m=edit"  class="qdxx"><img src="<?=base_url()?>m/static/images/sczp_btn3.jpg"></a></div> -->
                      <div class="btn"><a href="<?=base_url()?>m/index.php?c=user&m=edit" class="qdxx"><img src="<?=base_url()?>m/static/images/sczp_btn4.png"></a></div> 
                </div> 
                  </form>
          </div>	 		
		</section>                		
