...
<link href="<?=base_url()?>m/static/css/style.css" type="text/css" rel="stylesheet">
<link href="<?=base_url()?>m/static/css/hdjs.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="<?=base_url()?>m/static/js/jquery.js"></script>
<script type="text/javascript" src="<?=base_url()?>m/static/js/jquery-1.4.4.min.js"></script>
...
<body>
 ...
 <?php Widget::website_header();?>
            <div class="hdjs">
                ...
                <div class="hdjs_zpzt">
                	<h3><img src="<?=base_url()?>m/static/images/hdjs_zpzt.png"></h3>
                    ...
                    <div class="hdjs_zhuti">
                        ...
                        <img src="<?=base_url()?>m/static/images/hdjs_dwhb.jpg">
                        <div class="clear"></div>
                    ...
                    <div class="hdjs_zhuti">
                        ...
                        <img src="<?=base_url()?>m/static/images/hdjs_treval.jpg">
                        <div class="clear"></div>
                    ...
                    <div class="hdjs_zhuti">
                        ...
                        <img src="<?=base_url()?>m/static/images/hdjs_kiss.jpg">
                        <div class="clear"></div>
                    ...
                    <div class="hdjs_zhuti">
                        ...
                        <img src="<?=base_url()?>m/static/images/hdjs_love.jpg">
                        <div class="clear"></div>
                ...
                <div class="hdjs_pxgz">
                	<h3><img src="<?=base_url()?>m/static/images/hdjs_guize.png"></h3>
                    <div class="pxgz_pxfs">
                    	<img src="<?=base_url()?>m/static/images/pxgz_wltp.jpg">
                        <div class="wltp">
                        	<h4>按照网络投票数量排名</h4>
                            <p>（大赛期间 每日、每周都会<br>&nbsp;&nbsp;&nbsp;评选出相应奖项）</p>
                        </div>
                        <img src="<?=base_url()?>m/static/images/pxgz_zjps.jpg">
                ...
                <div class="hdjs_tpgz">
                	<h3><img src="<?=base_url()?>m/static/images/hdjs_tpgz.png"></h3>
