	  ...
	  {id:'1',
	  	menu:
			[
				...
				{text:'会员管理',
					items:[
							{id:'18',text:'会员列表',href:'index.php?d=home&c=member'},
              ...
              {id:'22',text:'获奖列表',href:'index.php?d=home&c=lottery_log&m=index'},
              {id:'23',text:'批量上传',href:'index.php?d=home&c=myupload'},
						]
